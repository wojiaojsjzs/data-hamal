...
public class EncodingDetect {
     ...
     * @return
     */
    public static Charset getCharset(String filePath) {
        return getCharset(new File(filePath));
    }

    public static Charset getCharset(File file) {
        String code = getJavaEncode(file);
        return Charset.forName(Objects.equals(code, "GB2312") ? "GBK" : code);
    }
    ...
    public static String getJavaEncode(File file) {
        ...
        return BytesEncodingDetect.javaname[detect.detectEncoding(file)];
    }
}
