...
import com.striveonger.study.task.common.executor.extra.ExecutorExtraInfo;
...
public class TaskTrigger {
    ...
    public ExecutorExtraInfo getExtra(String key) {
    ...
    public Map<String, ExecutorExtraInfo> getExtraMap() {
        return extras;
    }
