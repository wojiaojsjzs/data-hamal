...
public class SegmentIDGen implements IDGen {
    ...
    private final ExecutorService threadPool = new ThreadPoolExecutor(5, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), new UpdateThreadFactory());
    private volatile boolean initOK = false;
    private final Map<String, SegmentBuffer> cache = new ConcurrentHashMap<String, SegmentBuffer>();
    private ILeafAllocService dao;
    ...
    public ILeafAllocService getDao() {
        return dao;
    }

    public void setDao(ILeafAllocService dao) {
        this.dao = dao;
    }
}
